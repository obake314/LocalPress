...
export default function Footer({ onNavigate }: FooterProps) {
  return (
    <>
      ...
      <section className="bg-ink-bg-2 py-16 md:py-20">
        <Container>
          <div className="flex flex-col gap-10 lg:flex-row lg:items-center lg:justify-between">
            <p className="max-w-xl text-lead text-white/80">
              LocalPress
            ...
            <div className="flex flex-wrap gap-4">
              <button
                ...
                className="border border-white/30 px-8 py-4 text-sm font-semibold text-white transition-colors hover:border-accent hover:text-accent"
              >
                企業・自治体のご担当者はこちら
              </button>
              <button
                onClick={() => onNavigate("pricing")}
                className="bg-accent px-8 py-4 text-sm font-semibold text-accent-foreground transition-colors hover:bg-accent-hover"
              >
                お問い合わせ
              </button>
            </div>
          ...
          <div className="py-20 md:py-24">
            ...
            <div className="mb-16 grid grid-cols-2 gap-x-8 gap-y-12 md:grid-cols-4">
              {columns.map(({ heading, items }) => (
                <div key={heading}>
                  <p className="eyebrow mb-6 text-accent">{heading}</p>
            ...
            {/* Prefecture map */}
            <div className="hairline border-t pt-14">
              <p className="eyebrow mb-8 text-white/40">
                LocalPress は全国へ順次拡大していきます
              </p>
              <div className="flex flex-col gap-12 lg:flex-row lg:gap-16">
                <div className="hidden aspect-square w-[260px] shrink-0 opacity-60 lg:block">
                  <JapanMap onNavigate={onNavigate} />
                </div>
                <div className="grid flex-1 grid-cols-2 gap-x-8 gap-y-12 sm:grid-cols-3">
            ...
            {/* Bottom */}
            <div className="hairline mt-14 flex flex-col items-start justify-between gap-6 border-t pt-10 sm:flex-row sm:items-center">
              <button
              ...
              >
                ...
                <span className="text-lead font-bold tracking-tight text-white">
                  LocalPress
                </span>
              </button>
